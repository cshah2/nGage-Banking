...
public class ConsumerTempData {
	...
	static{
		...
		CUSTOMERDATA_MAP.put(Fields.CUST_ID, "12")
		...
		CUSTOMERDATA_MAP.put(Fields.URL, 'https://savossit.savanainc.com/nGageBanking_Customer/CustomerMainFlow.CustomerDetail.aspx?partyId=4UJEiDMNCEebHF--0-9F-Bg-&customerId=12&customerGroup=2')
	...
	static{
		...
		NA_CUSTOMERDATA_MAP.put(Fields.CONTACT_EMAIL, "abc@haio.com")
		NA_CUSTOMERDATA_MAP.put(Fields.CONTACT_EMAIL_TYPE, "Personal")
	...
	static{
		...
		ACCOUNT_HOLD.put(Fields.HOLD_AMOUNT_VIEW, "15.00")
	...
	static {
		...
		ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_ACCOUNT_NUMBER,ConsumerData.ACC_B2_POS1.get(Fields.ACC_NUMBER))
		ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_FROM_ACCOUNT_NUMBER,ConsumerData.ACC_B1.get(Fields.ACC_NUMBER))
		ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_TITLE,ConsumerData.ACC_B2_POS1.get(Fields.ACC_TITLE))
		ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_ROUTING_NUMBER,"043000096")
		ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_POSITION_NUMBER,ConsumerData.ACC_B2_POS1.get(Fields.ACC_POSITION_NUMBER))

		ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_GROUP,ConsumerData.ACC_B2_POS1.get(Fields.ACC_GROUP))
	...
	static {
		...
		ACCOUNT_PAYEMENT_ORDER.put(Fields.ORDER_OPERATIONL_AREA,"Back Office")
				ACCOUNT_PAYEMENT_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_ACCOUNT_NUMBER,ConsumerData.ACC_B2_POS1.get(Fields.ACC_NUMBER))
		ACCOUNT_PAYEMENT_ORDER.put(Fields.ORDER_COUNTERPARTY_FROM_ACCOUNT_NUMBER,ConsumerData.ACC_B1.get(Fields.ACC_NUMBER))
			ACCOUNT_PAYEMENT_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_TITLE,ConsumerData.ACC_B2_POS1.get(Fields.ACC_TITLE))
		ACCOUNT_PAYEMENT_ORDER.put(Fields.ORDER_ROUTING_NUMBER,"043000096")
		ACCOUNT_PAYEMENT_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_POSITION_NUMBER,ConsumerData.ACC_B2_POS1.get(Fields.ACC_POSITION_NUMBER))

		ACCOUNT_PAYEMENT_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_GROUP,ConsumerData.ACC_B2_POS1.get(Fields.ACC_GROUP))
		ACCOUNT_PAYEMENT_ORDER.put(Fields.ORDER_INFO,"Demo Order")
	...
	static {
		...
		ACCOUNT_COLLECTION_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_ACCOUNT_NUMBER,ConsumerData.ACC_B1.get(Fields.ACC_NUMBER))
		ACCOUNT_COLLECTION_ORDER.put(Fields.ORDER_COUNTERPARTY_FROM_ACCOUNT_NUMBER,ConsumerData.ACC_B2_POS1.get(Fields.ACC_NUMBER))
		ACCOUNT_COLLECTION_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_TITLE,ConsumerData.ACC_B2_POS1.get(Fields.ACC_TITLE))
		ACCOUNT_COLLECTION_ORDER.put(Fields.ORDER_ROUTING_NUMBER,"043000096")
		ACCOUNT_COLLECTION_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_POSITION_NUMBER,ConsumerData.ACC_B2_POS1.get(Fields.ACC_POSITION_NUMBER))
		ACCOUNT_COLLECTION_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_GROUP,ConsumerData.ACC_B2_POS1.get(Fields.ACC_GROUP))
		ACCOUNT_COLLECTION_ORDER.put(Fields.ORDER_INFO,"Banking")
	...
	static {
		...
		TO_ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_ACCOUNT_NUMBER,ConsumerData.ACC_B2_POS1.get(Fields.ACC_NUMBER))
		TO_ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_FROM_ACCOUNT_NUMBER,ConsumerData.ACC_B1.get(Fields.ACC_NUMBER))
		...
		TO_ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_GROUP,ConsumerData.ACC_B2_POS1.get(Fields.ACC_GROUP))

		
		TO_ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_POSITION_NUMBER,ConsumerData.ACC_B2_POS1.get(Fields.ACC_POSITION_NUMBER))
		...
		TO_ACCOUNT_BOOKTRANSFER_ORDER
		TO_ACCOUNT_BOOKTRANSFER_ORDER.put(Fields.URL,ConsumerData.ACC_B2_POS1.get(Fields.URL))
	}
...
/*		CUST_COMPLAINT.put(Fields.CUST_COMPLAINT_SOURCE, "DOJ")
	...
	static {
		...
		ACCOUNT_INTEREST_CHK.put(Fields.ACC_NUMBER, ConsumerData.ACC_B1.get(Fields.ACC_NUMBER))
		ACCOUNT_INTEREST_CHK.put(Fields.URL, ConsumerData.ACC_B1.get(Fields.URL))
