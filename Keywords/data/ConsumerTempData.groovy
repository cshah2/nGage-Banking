...
public class ConsumerTempData {
	...
	//account order map
	public static final Map<Fields, String> ACCOUNT_ORDER;
	static {
		ACCOUNT_ORDER = new HashMap<Fields, String>()

		ACCOUNT_ORDER.put(Fields.ORDER_TYPE,"Book transfer")
		ACCOUNT_ORDER.put(Fields.ORDER_ORIGIN_SOURCE,"Prearranged")
		ACCOUNT_ORDER.put(Fields.ORDER_SOURCE,"Bank operations")
		ACCOUNT_ORDER.put(Fields.ORDER_OPERATIONL_AREA,"Back Office")

		ACCOUNT_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_ACCOUNT_NUMBER,"200120201234")
		ACCOUNT_ORDER.put(Fields.ORDER_COUNTERPARTY_FROM_ACCOUNT_NUMBER,"000000002550")
		ACCOUNT_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_TITLE,"Savings Account")

		ACCOUNT_ORDER.put(Fields.ORDER_COUNTERPARTY_ACCOUNT_GROUP,"Banking")
		ACCOUNT_ORDER.put(Fields.ORDER_COUNTERPARTY_TO_ACCOUNT_TYPE,"Demand deposit account")
		ACCOUNT_ORDER.put(Fields.ORDER_TRANSFER_AMOUNT,"13.00")
		ACCOUNT_ORDER.put(Fields.ORDER_CREATED_DATE, DateUtil.getCurrentDateTime(Common.dateTimeFormat, Common.timezoneUTC))
		ACCOUNT_ORDER.put(Fields.ORDER_DATE, DateUtil.getCurrentDateTime(Common.dateTimeFormat, Common.timezoneUTC))
		
		ACCOUNT_ORDER.put(Fields.URL,"https://savossit.savanainc.com/nGageBanking_Account/AccountMainFlow.AccountDetail.aspx?partyId=4TeSCPmgC7M__V---V9F-Bg-&acctGroup=1&acctNumber=000000002550&selectedPositionId=4TeSG8FHC2N2Q----V9F-Co-&customerGroup=2&customerId=7&isOrg=False")
	}
}
