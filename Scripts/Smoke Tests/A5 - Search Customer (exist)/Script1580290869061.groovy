...
CustomKeywords.'actions.WebTable.verifyAllValuesInColumnMatches'(tableSearchResults, ColumnPosition.CUST_LAST_NAME, customerData.get(Fields.CUST_LAST_NAME), Operator.EQUALS_IGNORE_CASE)
...
CustomKeywords.'actions.WebTable.verifyAllValuesInColumnMatches'(tableSearchResults, ColumnPosition.CUST_FIRST_NAME, customerData.get(Fields.CUST_FIRST_NAME), Operator.EQUALS_IGNORE_CASE)
...
'Verify Firstname is present in all rows of searchResults table'
CustomKeywords.'actions.WebTable.verifyAllValuesInColumnMatches'(tableSearchResults, ColumnPosition.CUST_EMAIL, customerData.get(Fields.CONTACT_EMAIL), Operator.EQUALS_IGNORE_CASE)
...
CustomKeywords.'actions.WebActions.waitForElementVisible'(findTestObject('Object Repository/SearchPage/SearchConsumer/SearchConsumerResults/text_ToolTip'), GlobalVariable.Timeout)

'Verify date of birth value'
CustomKeywords.'actions.WebActions.verifyMatch'(WebUI.getText(findTestObject('Object Repository/SearchPage/SearchConsumer/SearchConsumerResults/text_ToolTip')), customerData.get(Fields.CUST_DOB), Operator.EQUALS)
...
CustomKeywords.'actions.WebTable.verifyAllValuesInColumnMatches'(tableSearchResults, ColumnPosition.CUST_PHONE_NUMBER, customerData.get(Fields.CONTACT_PHONE_NUMBER), Operator.EQUALS_IGNORE_CASE)
...
CustomKeywords.'actions.WebActions.verifyMouseOverText'(findTestObject('SearchPage/SearchConsumer/SearchConsumerResults/icon_TaxIDEye'), findTestObject('Object Repository/SearchPage/SearchConsumer/SearchConsumerResults/text_ToolTip'), customerData.get(Fields.CUST_TAX_ID), Operator.EQUALS)
...
WebUI.selectOptionByLabel(findTestObject('Object Repository/SearchPage/SearchConsumer/select_CustomerGroup'), customerData.get(Fields.CUST_GROUP), false)
