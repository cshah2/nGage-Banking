...
'Type Routing Number'
CustomKeywords.'actions.WebActions.typeText'(findTestObject('Account/AccountTaskDrawer/AddOrder/input_RoutingNumber'), custOrderData.get(Fields.ORDER_ROUTING_NUMBER))
...
'Type Account Number'
CustomKeywords.'actions.WebActions.typeText'(findTestObject('Account/AccountTaskDrawer/AddOrder/input_AccountNum'), custOrderData.get(Fields.ORDER_COUNTERPARTY_FROM_ACCOUNT_NUMBER))
...
CustomKeywords.'actions.WebTable.verifyCellValueMatches'(scheduledTransactionsTable, LATEST_ROW, ColumnPosition.ORDER_STATUS,
	TRANSACATION_STATUS, Operator.EQUALS_IGNORE_CASE)
...
CustomKeywords.'actions.WebTable.verifyCellValueMatches'(openCases, LATEST_ROW, ColumnPosition.CASE_TYPE,
	COLLECTION_ORDER_CASE_TYPE, Operator.EQUALS_IGNORE_CASE)
